  ...
  <div class="dd-l-plate">
    <div class="row">
      <div class="column large-4 small-12">
        <div class="dd-info">
          <h2 class="t-headline">Mix. Match. MagSafe.</h2>
          <p class="t-intro">Snap on a MagSafe case, wallet, or wireless charger. </p>
        </div>
      </div>
...
<div>
  ...
  <div class="dd-l-plate">
    <div class="row">
      <div class="column large-4 small-12">
         <div class="dd-info">
             <p class="t-eyebrow">New</p>
             <h2 class="t-headline">
                It’s magic, remastered.
          	 </h2>
             <p class="t-intro">
           		 Spatial audio with dynamic head tracking in an all-new design.
			 </p>
             <p class="t-intro">
      ...
      tabLinks: {
        items: [{
            ...
            value: {
              ...
              text: "Browse by Product",
              dataVar: {},
              omnitureData: {
                slotName: "main4",
                featureName: "category product browser",
                linkText: "tabs-0 : tab-link : Browse by Product",
                commitCodeId: 0,
              },
              newTab: false,
          ...
          },
          {
            ...
            value: {
              ...
              omnitureData: {
                slotName: "main4",
                featureName: "category product browser",
                linkText: "tabs-1 : tab-link : Browse by Category",
                commitCodeId: 0,
              },
              newTab: false,
    ...
    <div>
      <ul class="row">
        <li class="rs-browser-list large-6 column">
          <a href="#" data-slot-name="main4" data-feature-name="category product browser" data-display-name="tabs-0 : tab-link : Browse by Product" class="rs-browser-itemlink">Browse by
            Product</a>
        </li>
        <li class="rs-browser-list large-6 column">
          <a href="#" data-slot-name="main4" data-feature-name="category product browser" data-display-name="tabs-1 : tab-link : Browse by Category" class="rs-browser-itemlink">Browse by
            Category</a>
        </li>
      </ul>
    </div>
  ...
  <div class="as-l-fullwidth as-pinwheel as-pinwheel15 as-pinwheel-isfooterlinkpresent" data-template="PW15_LR1S4-flex">
    <div class="as-l-container">
      <div class="as-pinwheel-header">
        <h2 class="as-pinwheel-title">Featured Apple Accessories</h2>
      </div>
    </div>
    ...
    <div class="as-pinwheel15-footer">
      <a href="#" data-slot-name="main6" data-feature-name="Astro Link" data-display-name="AOS: home/shop_accessories/all_accessories/made_by_apple" class="category-link fwl more less-is-more">Shop Apple accessories</a>
    </div>
  </div>
  ...
  <div class="as-l-fullwidth as-pinwheel as-pinwheel14 as-pinwheel14-8tiles as-pinwheel-isfooterlinkpresent" data-template="PW14_Carousel">
    <div class="as-l-container">
      <div class="as-pinwheel-header">
        <h2 class="as-pinwheel-title">Wireless Headphones</h2>
      </div>
    </div>
...
<img src="https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/MXJ92_SW_COLOR?wid=16&amp;hei=16&amp;fmt=png-alpha&amp;.v=1580420171709" class="ir " alt="Shadow Gray" width="16" height="16" data-scale-params-2="wid=32&amp;hei=32&amp;fmt=png-alpha&amp;.v=1580420171709" data-scale-initial="1"   />
	...
	<li class="as-producttile-moretext">+</li>
      ...
      <div class="as-pinwheel14-footer">
        <a href="https://www.apple.com/th-en/shop/accessories/all/wireless-headphones" data-slot-name="main9" data-feature-name="Astro Link" data-display-name="AOS: home/shop_accessories/all_accessories/wireless_headphones" class="category-link fwl more less-is-more">Shop all Wireless Headphones</a>
      </div>
    </div>
              ...
              <div class="buystrip-item-content superlink">
                <a href="#" data-slot-name="main22" data-feature-name="Astro Link" data-display-name="AOS: campaigns/shipping_and_returns" class="block">
                  ...
                  <h3 class="buystrip-item-title">
                    Pick up at an Apple Store
                  </h3>
                  <p class="buystrip-item-copy">
                    Buy online and pick up available items.
                  </p>
                  <span class="block-link buystrip-item-cta more">Learn&nbsp;more<span class="a11y">Pick up at an
                      Apple
                      Store</span></span>
                </a>
              </div>
            ...
            <section class="buystrip-item">
              <div class="buystrip-item-content superlink">
                <a href="#" data-slot-name="main22" data-feature-name="Astro Link" data-display-name="AOS: campaigns/shipping_and_returns" class="block">
                  ...
                  <h3 class="buystrip-item-title">Free delivery</h3>
                  <p class="buystrip-item-copy pd-util-compact-large-10 pd-util-compact-small-5">
                    Get free delivery direct to your door.
                  </p>
                  <span class="block-link buystrip-item-cta more">Learn&nbsp;more<span class="a11y">Free
                      delivery</span></span>
                </a>
              </div>
            </section>
            ...
            <section class="buystrip-item">
              <div class="buystrip-item-content superlink">
                <a href="#" class="block">
                  ...
                  <span class="block-link buystrip-item-cta more">Learn&nbsp;more<span class="a11y">Financing</span></span>
                </a>
              </div>
            </section>
          </section>
